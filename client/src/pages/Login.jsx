    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .input-wrap input.has-error { border-color: #ef4444; box-shadow: 0 0 0 3px rgba(239,68,68,0.1); }
        .toggle-pw {
          position: absolute; right: 12px; top: 50%; transform: translateY(-50%);
          background: none; border: none; cursor: pointer; color: #4b5563; font-size: 0.85rem; padding: 4px;
          transition: color 0.2s;
        }
        .toggle-pw:hover { color: #9ca3af; }
        .field-error { margin-top: 6px; font-size: 0.78rem; color: #f87171; display: flex; align-items: center; gap: 4px; }
        ...
        .login-panel {
          ...
          align-items: flex-start; padding: 4rem; position: relative; overflow: hidden;
        }
        .login-panel::before {
        ...
        .panel-quote {
          ...
          color: #f8fafc; margin-bottom: 1.5rem; position: relative; z-index: 1;
        }
        ...
        .jwt-badge-title { font-size: 0.75rem; font-weight: 600; color: #818cf8; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 8px; }
        .jwt-code { font-family: monospace; font-size: 0.75rem; color: #64748b; word-break: break-all; line-height: 1.6; }
        .jwt-code span { color: #a5b4fc; }
      ...
      <div className="login-root">
        ...
        <div className="login-panel">
          <p className="panel-quote">
            Your ideas<br />deserve an<br /><em>audience.</em>
          </p>
          <p className="panel-sub">
            Sign in to access your dashboard, manage your content, and connect with your readers.
          </p>
          <div className="jwt-badge">
            <div className="jwt-badge-title">🔐 Secured with JWT</div>
            <div className="jwt-code">
              <span>eyJhbGciOiJIUzI1NiJ9</span>.eyJpZCI6IjY1YTEi<span>...</span>
            </div>
          </div>
        </div>
      </div>
